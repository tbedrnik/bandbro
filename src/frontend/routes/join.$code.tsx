...
function JoinPage() {
	...
	return (
		<div className="grid min-h-dvh place-items-center bg-background px-6 py-10 text-foreground">
							...
							{session ? (
								<>
									...
									{redeem.isError && (
										<p className="mt-3 text-sm text-destructive">
											That didn't work — the link may have just expired or been
											used up.
										</p>
									)}
								</>
								...
								<>
									<p className="mt-5 text-sm text-muted-foreground">
										Sign in (or create an account) and you'll come straight back
										here.
									</p>
